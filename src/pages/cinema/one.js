      ...
      <View className='one-cinema'>
        <View className='bg_one_cinema'>
          ...
          <View className='bg-cinema_content'>
            <View className='normal-text' style={{ fontSize: '15px' }}>
        ...
        <View className='tigger-current_movie'>
          ...
          <View>
            评分 : <Text style={{ color: '#faaf00' }}>{this.state.tiggerMovie.score}</Text> 分
          </View>
          <View>导演 : {this.state.tiggerMovie.director}</View>
        </View>
        <View className='order-ticket' onClick={this.handleOrderTicket}>
          立即购票
        </View>
      </View>
    )
