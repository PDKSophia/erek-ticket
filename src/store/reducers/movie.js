...
const INITIAL_STATE = {
  ...
  movieList: [
    {
      desc: '时好意会造成恶果，人反而被自己所造成的结果所困扰。伊桑·亨特（汤姆·克鲁斯）和他的IMF团队（亚历克·鲍德温、西蒙·佩吉、文·瑞姆斯）再度回归，他们会与观众们熟悉的盟友（丽贝卡·弗格森、米歇尔·莫娜汉）一起与时间赛跑，应对一次任务中出现的',
      director: '克里斯托弗·麦奎里',
      id: 1,
      name: '碟中谍6：全面瓦解',
    ...
    {
      desc: '斯科特·朗迎来了自己作为超级英雄和孩子父亲的双重身份。一方面，他在背负着蚁人职责的同时努力过好自己的生活；另一方面，二代黄蜂女霍普·凡·戴恩和汉克·皮姆博士又向他传达了一项紧迫的新任务。斯科特必须再次穿上战衣，与黄蜂女并肩作战，共同破解来自',
      director: '佩顿·里德',
      id: 2,
      name: '蚁人2：黄蜂女现身',
    ...
    {
      desc: '有一个每天耍贱整蛊妹妹、毫无家庭感的哥哥是一种什么感受？油炸还是蒸锅？时秒只希望哥哥时分彻底消失！连珍贵的生日愿望都是“快把我哥带走”。不料愿望成真，哥哥变成闺蜜妙妙的哥哥，时秒同情妙妙的同时心里暗爽摆脱“大魔王”！变成独生女的时秒感觉生',
      director: '郑芬芬',
      id: 3,
      name: '快把我哥带走',
    ...
    {
      desc: '来自印度北方小镇的苏丹遇见了摔跤教练的女儿，苏丹为了心仪女孩，不仅开始学起摔跤，在短时间内就获得地方冠军，展现了他的决心和天分。他不但娶得美人归，还和妻子一起代表印度参加奥运，但就在苏丹获得奥运金牌的同时，他却因为骄傲自大而失去了挚爱的家庭',
      director: '阿里·阿巴斯·札法',
      id: 4,
      name: '苏丹',
    ...
    {
      desc: '讲述了二战期间，发生在长江边上的一座悲情城市里的凄婉美丽的女人故事，通过回忆的视角再现了那个腥风血雨的年代，一群不同身份、性情各异的女子，在家仇国恨面前，抛弃前嫌，不计恩怨，与日寇、汉奸、汪伪特工巧妙周旋、斗智斗勇，最后不惜牺牲性命，在血与火的洗礼中涅槃永生',
      director: '吴贻弓',
      id: 5,
      name: '那些女人',
